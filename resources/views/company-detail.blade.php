			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navbar-menu">
					<ul class="nav navbar-nav navbar-right" data-in="fadeInDown" data-out="fadeOutUp">
							<li id="thehome"><a href="#">Home</a></li>
							<li id="session-li"><a href="#">Login</a></li>
							<li id="companiesP"><a href="#">Companies</a></li>
							<li><a href="characters.html">Trabajos premium</a></li>
		...
		<footer>
			<div class="container">
				...
				<div class="col-md-3 col-sm-6">
					...
					<ul>
						<li><a href="#">Estudiante Ing. en Sistemas</a></li>
						<li><a href="#">Email: juan.palomino@upb.edu.co</a></li>
						<li><a href="#">Tel: 311304940</a></li>
					</ul>
				</div>
				...
				<div class="col-md-3 col-sm-6">
					...
					<li>Email: andres.romana@upb.edu.co</li>
					<li>Tel: 311407406</li>
					</ul>
					</address>
				</div>
